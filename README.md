# Innomatics Research Labs - Internship Assessments 🚀
...
1. **`InnomaticsResearchLabs_EntranceTest.ipynb`**
   ...
   * **Skills Demonstrated:** Data cleaning, data merging (CSV, JSON, SQL), and data analysis using Python and the Pandas library. 

2. **`Logic_Building_Task_1.ipynb`**
...
---
*Created by Shaik Mazher | CSE AI & ML Student*
